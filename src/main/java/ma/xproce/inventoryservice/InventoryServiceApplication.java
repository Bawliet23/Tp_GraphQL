...
public class InventoryServiceApplication {
    ...
    public CommandLineRunner start(CreatorRepository creatorRepository, VideoRepository videoRepository){
        return args -> {
          ...
          Creator c = Creator.builder().name("Mohamed").email("Mohamed@gmail.com").build();
          Creator c2 = Creator.builder().name("Mohamed2").email("Mohamed@gmail.com").build();
          Creator c3 = Creator.builder().name("Mohamed3").email("Mohamed@gmail.com").build();
